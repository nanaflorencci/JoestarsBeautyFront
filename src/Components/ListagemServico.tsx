                                ...
                                <tbody>
                                    {servicos.map(servicos => (
                                        <tr key={servicos.id}>
                                            ...
                                            <td>
                                            <Link to={"/EditarServicos/" + servicos.id} className='btn btn-secondary btn-sm m-1'>Editar</Link>
                                                <a onClick={e => handleDelete(servicos.id)} className='btn btn-dark btn-sm'>Excluir</a>
                                            </td>
                                        </tr>
                                    ))}
                                </tbody>
